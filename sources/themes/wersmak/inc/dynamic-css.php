...
function kapee_theme_style() {	
	...
	$theme_css = '
		...
		*/
		...
		.whishlist-button .yith-wcwl-wishlistexistsbrowse a:before,
		.whishlist-button .yith-wcwl-wishlistaddedbrowse a:before
		{
			font-family: "FontAwesome";
			content : "\f004";
			text-shadow: 0 0 3px '.$style_options['site']['primary_color'].';
    		color: '.$style_options['site']['primary_color'].';
		}
