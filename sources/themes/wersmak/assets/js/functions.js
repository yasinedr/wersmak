...
(function($) { 
	...
	kapee.backToTop = function(){
		...
		/* 		window.addEventListener('scroll', () => {
			$('.kapee-back-to-top').toggleClass('activescrol', window.scrollY > 100)
		}) */
	...
	kapee.productHover = function (){
		...
		* productHover grid
		*/
		$('.carousel-group .product').mouseenter(function(){
			var product_elemnt = $(this);
			var variations = product_elemnt.find('.product-variations');
			var product_title = product_elemnt.find('.product-title-rating');
			var product_price = product_elemnt.find('.product-price');
			var variations_height = variations.height();			
			if(variations_height && variations_height > 0){				
				variations.css('transform', 'translate3d(0px, -'+variations_height+'px, 0px)');
				product_title.css('transform', 'translate3d(0px, -'+variations_height+'px, 0px)');
				product_price.css('transform', 'translate3d(0px, -'+variations_height+'px, 0px)');
				variations.addClass('active-variation');
			} 
		}).mouseleave(function(){
			var product_elemnt = $(this);
			var variations = product_elemnt.find('.product-variations');
			var product_title = product_elemnt.find('.product-title-rating');
			var product_price = product_elemnt.find('.product-price');
				variations.css('transform', 'translate3d(0px, 0px, 0px)');
				product_title.css('transform', 'translate3d(0px, 0px, 0px)');
				product_price.css('transform', 'translate3d(0px, 0px, 0px)');
				variations.removeClass('active-variation');
