...
<?php else : ?>
	...
	<div class="woocommerce-mini-cart-empty">
		...
		<p class="woocommerce-mini-cart__empty-message"><?php echo apply_filters( 'kapee_woocommerce_empty_mini_cart_message', esc_html__( 'Shopping cart is empty!', 'woocommerce' ) ); ?></p>	
